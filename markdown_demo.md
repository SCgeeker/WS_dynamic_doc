...
<!--- render this document in command line
Source: http://www.unexpected-vortices.com/sw/rippledoc/index.html
command: pandoc markdown_demo.md -o markdown_demo.pdf --pdf-engine=xelatex
command: pandoc --filter pandoc-citeproc markdown_demo.md -o markdown_demo.pdf --pdf-engine=xelatex
--->
...
![example image](Workshop-Open-Science1.png "An exemplary image")
...
## Cite articles in your manuscript 
